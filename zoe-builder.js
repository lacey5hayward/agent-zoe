// Phase 5 + 6: Consolidated Zoe Builder & File Store (v2.4.2)
// Combines IndexedDB file management and the Build Agent into a single file
// to completely eliminate cross-script loading and communication issues on iPad/Safari.
...
async function send(text) {
  ...
  // v2.4.2: Direct access to UsFiles since they are in the same file
  ...
  try {
    ...
    if (!targetContent) {
      // Fallback: try fetching it right now if IDB was empty
      try {
